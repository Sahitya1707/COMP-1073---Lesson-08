...
const person = {
  ...
  age: 58,
  interest: ["Camping", "Learning", "Playing"],
  greeting() {
    // alert(`Hi, I'm ${this.name} and I am ${this.age} years old.`);
    let greeting = `Hi, I'm ${this.name.first} and I am ${this.age} years old and I enjoy ${this.interest[2]}.`;
